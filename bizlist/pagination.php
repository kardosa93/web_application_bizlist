...
$sql = "SELECT count(*) FROM greenhouse";
$result = mysql_query($sql, $conn) or trigger_error("SQL", E_USER_ERROR);
$r = mysql_fetch_row($result);
$numrows = $r[0];
echo "<div class='services'><h5>";
echo "<div class='services'><h5>Number of businesses: ". $numrows;
echo "</h5></div><br />";
...
$sql = "SELECT date_time, ext_temperature, int_temperature, humidity FROM greenhouse ORDER BY date_time DESC LIMIT $offset, $rowsperpage";
$result = mysql_query($sql, $conn) or trigger_error("SQL", E_USER_ERROR);
